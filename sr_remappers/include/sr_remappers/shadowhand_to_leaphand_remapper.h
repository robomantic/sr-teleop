...
#ifndef   	SHADOWHAND_TO_LEAPHAND_REMAPPER_H_
# define   	SHADOWHAND_TO_LEAPHAND_REMAPPER_H_
...
class ShadowhandToLeaphandRemapper
{
 ...
 private:
  ...
  /// subscriber to the jointstates topic from the leaphand
  Subscriber leaphand_jointstates_sub;
  ...
  /**
   * process the joint_states callback: receives the message from the leaphand node, remap it to the Dextrous hand and
...
#endif 	    /* !SHADOWHAND_TO_LEAPHAND_REMAPPER_H_ */
